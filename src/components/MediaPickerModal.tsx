...
const styles = StyleSheet.create({
  ...
  cameraIcon: { backgroundColor: '#007AFF' },
  libraryIcon: { backgroundColor: '#34C759' },
  iconText: { fontSize: 20, fontWeight: '700', color: '#FFFFFF' },
  ...
  optionSubtitle: { fontSize: 13, color: '#8E8E93' },
  cancelButton: {
    marginTop: 12,
    marginHorizontal: 20,
    paddingVertical: 16,
  ...
  cancelText: { fontSize: 17, fontWeight: '600', color: '#007AFF' },
});
